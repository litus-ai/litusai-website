        ...
        <div className="bg-primary/[.04] py-3">
          <div className="container">
            <p className="text-center text-sm text-body-color dark:text-white">
              ...
              <br />
              <a href="https://www.iubenda.com/privacy-policy/76198193"
                 className="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe" title="Privacy Policy ">
                Privacy Policy
              </a>
              <span style={{marginLeft: 5, marginRight: 5}}>&nbsp;</span>
              <a href="https://www.iubenda.com/privacy-policy/76198193/cookie-policy"
                 className="iubenda-white iubenda-noiframe iubenda-embed iubenda-noiframe" title="Cookie Policy ">
                Cookie Policy
              </a>
            </p>
          </div>
